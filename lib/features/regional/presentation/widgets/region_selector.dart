...
class RegionSelector extends StatelessWidget {
  ...
  static const Map<String, Map<String, String>> districtCodes = {
    '11': {
      '종로구': '11110',
      '중구': '11140',
      '용산구': '11170',
  ...
  static String getCityCode(String city) {
    return cityCodes[city] ?? '';
  }

  static String getDistrictCode(String cityCode, String district) {
    final districts = districtCodes[cityCode];
          ...
          child: Column(
            children: [
              DropdownButtonFormField<String>(
                ...
                items: cityCodes.keys.map((String city) {
              ...
              if (provider.selectedCity != null &&
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: districtCodes[cityCodes[provider.selectedCity]]
                      ?.keys
                      .map((String district) {
                    return DropdownMenuItem<String>(
                      value: district,
